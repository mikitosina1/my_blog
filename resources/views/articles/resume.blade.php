		...
		<div class="string_1">
			<div class="left">
				...
				<div class="mt-4 step_1 additional">
					...
					<div class="row">
						<x-text-input id="additional0" class="block mt-1 w-full" type="text" name="additional[0]"
									  :value="old('additional0')" required autocomplete="additional0"/>
				...
				<div class="mt-4 step_3 bordered experience">
					...
					<x-text-input id="experience0" class="block mt-1 w-full" type="text" name="experience[0][title]"
								  :value="old('experience')"/>
					<x-input-label for="experience_desc0" :value="__('page.description')"/>
					<x-textarea-input id="experience_desc0" class="block mt-1 w-full" type="textarea"
									  name="experience[0][description]" :value="old('experience')"/>
				</div>
				...
				<div class="mt-4 step_4 bordered studying">
					...
					<x-text-input id="studying" class="block mt-1 w-full" type="text" name="studying[0][title]"
								  :value="old('studying')"/>
					<x-input-label for="studying_desc" :value="__('page.description')"/>
					<x-textarea-input id="studying_desc" class="block mt-1 w-full" type="textarea"
									  name="studying[0][description]" :value="old('studying_desc')"/>
				</div>
				...
				<div class="mt-4 step_5 bordered certificates">
					...
					<x-text-input id="certificates" class="block mt-1 w-full" type="text" name="certificates[0][title]"
								  :value="old('certificates')"/>
					<x-input-label for="certificates_desc" :value="__('page.certificates_url')"/>
					<x-textarea-input id="certificates_desc" class="block mt-1 w-full" type="textarea"
									  name="certificates[0][description]" :value="old('certificates_desc')"/>
				</div>
			...
			<div class="right">
				...
				<div class="mt-4 step_1">
					...
					<x-text-input id="address" class="block mt-1 w-full" type="text" name="address"
								  :value="old('address')" required autocomplete="address-level2"/>
				</div>
